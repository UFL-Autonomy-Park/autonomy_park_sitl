...
"$SCRIPT_DIR/library/kill_ros2_autonomy_stack.sh"
...
# session/process group, so library/kill_ros2_autonomy_stack.sh can kill
...
trap '"$SCRIPT_DIR/library/kill_ros2_autonomy_stack.sh"; exit 0' INT TERM
